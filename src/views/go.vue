			...
			<div class="flex flex-wrap items-center -m-8">
				<div class="w-full md:w-2/4 p-8">
					<div class="m-auto flex items-center justify-center">
						<img class="bg-yellow-200 transform hover:-translate-y-2 transition duration-500 rounded-2xl" :src="`https://robohash.org/` + btcaddress + `.png?set=set2&size=500x500`" alt="" />
					</div>
				</div>
				<div class="w-full md:w-2/4 p-8">
						...
						<div class="flex flex-wrap -m-4">
							<div class="w-full lg:w-4/4 p-4">
								<h2 class="mb-2 text-xl font-bold uppercase">
									You're in the top
									<span class="bg-blue-100">{{ rankpostest }}</span> of all Bitcoin addresses—ranked <span class="bg-green-100">#{{ myrank }}</span> out of
							...
							<div class="w-full lg:w-2/4 p-4">
								<div class="p-6 rounded bg-white">
									...
									<h2 class="mb-2 text-xl font-bold">{{ biggestbalance }} BTC</h2>
